...
This script provides a command-line dashboard to monitor the progress and resource
usage of model training jobs, including system, GPU, checkpoint, and log status.
"""
...
class TrainingMonitor:
    """
    Class for monitoring training progress, system resources, and logs.
    """

    def __init__(self, dataset: str):
        """
        Initialize the monitor for a given dataset.

        Args:
            dataset (str): Name of the dataset (e.g., 'gsm8k', 'ragbench').
        """
    ...
    def get_gpu_stats(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: GPU stats for each available GPU.
        """
        gpus = GPUtil.getGPUs()
        return {
            f"gpu_{i}": {
    ...
    def get_latest_checkpoint(self) -> Dict[str, Any]:
        """
        Find the latest checkpoint and its metadata.

        Returns:
            dict: Info about the latest checkpoint, or error/status message.
        """
        try:
            checkpoints = sorted(
    ...
    def get_training_stats(self) -> Dict[str, Any]:
        """
        Get training statistics from log files.

        Returns:
            dict: Current step, latest/average rewards, recent errors, and log file info.
        """
        try:
            # Find the latest log file for the dataset
            latest_log = sorted(
            ...
            # Parse rewards and other metrics from log lines
            rewards: List[Dict] = []
            errors: List[str] = []
            current_step = 0
    ...
    def get_system_stats(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: CPU, memory, disk usage, and running time.
        """
        return {
    ...
    def get_tmux_status(self) -> Dict[str, Any]:
        ...
        Returns:
            dict: Whether the tmux session is active and its name.
        """
        try:
    ...
    def display_status(self) -> None:
        """
        Display current training, system, and resource status in the terminal.
        """
        os.system('clear')
...
def main():
    """
    Main entry point for the training monitor.
